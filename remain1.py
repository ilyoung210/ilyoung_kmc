...
def select_material():
    print("어떤 물질로 시작하시겠습니까?")
    print("1) HZO")
    print("2) HfO2")
    print("3) ZrO2")
    print("4) Si-doped HfO2")
    choice = input("번호를 선택하세요: ").strip()
    if choice == '1':
        print("HZO를 선택하였습니다.")
    elif choice in ['2','3','4']:
        print("현재 HZO 물성만 준비되어 있으므로, HZO로 진행합니다.")
    else:
        print("잘못된 입력. 기본값(HZO)로 진행합니다.")
    logging.info("[Material] Using HZO parameters (only).")
            ...
            for (sT,eT,sc) in segments:
                ...
                for local_stp in range(sc):
                    ...
                    for _a in range(Nsize*Nsize):
                        ...
                        accepted, used_barrier= attempt_flip(spins_off,x,y,Nsize,T_now,J)
